...
const HERO_SLIDES = [
  {
    headline: "Together, We Rise by Lifting Others.",
    description: "Join a purpose-driven community of volunteers, mentors, and changemakers turning compassion into action. Every contribution helps build stronger communities and creates meaningful impact that lasts.",
  ...
  },
  {
    ...
    description: "Real change isn't created by individuals alone—it's built by communities that choose to act together. Become part of a movement where every contribution counts.",
  ...
  {
    headline: "Volunteer Your Way.",
    description: "From community initiatives to skill-based volunteering, choose opportunities that match your passion, schedule, and strengths.",
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 invisible pointer-events-none">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex items-center gap-2 text-sm">
              ...
              <span>
                <strong className="font-semibold">Since 2017</strong>
              </span>
            </div>
          </div>
            ...
            <div className="mx-auto w-full max-w-7xl grid items-center gap-10 lg:grid-cols-2">
              ...
              <div className="flex flex-col justify-center pointer-events-auto">
                ...
                <div className="mt-8 flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>
                    <strong className="font-semibold text-foreground">Since 2017</strong> • Building a community united by purpose and driven by impact.
                  </span>
                </div>
              </div>
        ...
        <section className="py-12 lg:py-20">
          <div className="mx-auto max-w-7xl px-5">
            <SectionHeading
              ...
              title="Learn. Volunteer. Create Change."
              description="Explore learning pathways and volunteer programs designed to help you build practical skills, contribute with confidence, and create meaningful impact."
            />
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 lg:grid-cols-2">
            <div>
              <SectionHeading
                ...
                description="You don't need years of experience to make a difference. Whether you share your skills, your time, or your ideas, there's a place for everyone to contribute and create positive change."
              />
              <ul className="mt-8 space-y-4">
                {[
                  { icon: Gift, text: "Share your skills where they're needed most" },
                  { icon: Heart, text: "Support meaningful community initiatives" },
                  { icon: Sparkles, text: "Inspire change through service and leadership" },
                ].map((item, i) => (
        ...
        <section className="border-y border-border bg-card py-12 lg:py-20">
          <div className="mx-auto max-w-7xl px-5">
            <SectionHeading
              ...
              description="Behind every meaningful change is a story of courage, compassion, and hope. Discover how volunteers, mentors, and communities are creating lasting impact—one life at a time."
            />
            <div className="mt-10 grid gap-6 md:grid-cols-3">
            ...
            <div className="mt-12 text-center">
              <Button asChild variant="outline" size="lg">
                <Link to="/success-stories">See More Journeys</Link>
              </Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 lg:py-20">
          <div className="mx-auto max-w-7xl px-5">
            <SectionHeading
              ...
              title="Learn. Grow. Stay Inspired."
              description="From volunteering and leadership to personal growth and social impact, discover resources that help you continue your journey."
            />
            <div className="mt-10 grid gap-6 md:grid-cols-3">
