          ...
          <div className="flex flex-col justify-center order-2 lg:order-1">
            ...
            <Reveal delay={0.1}>
              <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-foreground mb-4">
                Creating a <span className="text-primary block">Culture of Giving</span>
              </h2>
            </Reveal>

            <Reveal delay={0.2}>
              <p className="text-lg leading-relaxed text-muted-foreground mb-10 max-w-xl">
                We believe that when people are recognized for creating impact, they are inspired to create even more. <strong className="text-foreground">Disha Coins</strong> celebrate every meaningful contribution and unlock opportunities that empower volunteers to keep serving, growing, and leading change.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.4}>
              <div className="flex flex-col items-start gap-3">
                ...
                <span className="text-sm font-semibold text-foreground">Creating Impact Beyond Volunteering.</span>
              </div>
            </Reveal>
          </div>
